...
if (DB_TYPE === 'postgres') {
  ...
  const connectionString = process.env.DATABASE_URL || 'postgresql://postgres:postgres@localhost:5432/huobao_drama'
  ...
  console.log(`📦 Database: PostgreSQL (${connectionString.replace(/\/\/.*@/, '//***@')})`)
} else {
